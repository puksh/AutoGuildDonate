...
["207931"] = true, -- CosmicRuby
["207327"] = true, -- HellEssence
["207331"] = true, -- PowerCore
["207323"] = true, -- MorningDew
["207321"] = true, -- ReadyWoodenCrate
["207319"] = true, -- MilkyWayPearl
...
function HerbLevelButtonOnEnter(this)
	...
	GameTooltip:AddSeparator()
	GameTooltip:AddLine("Yellow Highlighted Checkboxes:", 1, 1, 0)
	GameTooltip:AddLine("Represent processed materials (Bundles, Saps, Extracts)", 1, 1, 1)
	GameTooltip:AddLine("that give higher contribution than raw herbs.", 1, 1, 1)
	GameTooltip:AddSeparator()
...
function MineLevelButtonOnEnter(this)
	...
	GameTooltip:AddSeparator()
	GameTooltip:AddLine("Yellow Highlighted Checkboxes:", 1, 1, 0)
	GameTooltip:AddLine("Represent processed materials (Ingots, Alloys, etc.)", 1, 1, 1)
	GameTooltip:AddLine("that give higher contribution than raw ores.", 1, 1, 1)
	GameTooltip:AddSeparator()
	GameTooltip:AddLine("Higher level materials give more guild contribution.", 0.8, 0.8, 0.8)
	GameTooltip:Show()
end
...
function WoodLevelButtonOnEnter(this)
	...
	GameTooltip:AddSeparator()
	GameTooltip:AddLine("Yellow Highlighted Checkboxes:", 1, 1, 0)
	GameTooltip:AddLine("Represent processed materials (Planks, Boards, etc.)", 1, 1, 1)
	GameTooltip:AddLine("that give higher contribution than raw wood.", 1, 1, 1)
	GameTooltip:AddSeparator()
	GameTooltip:AddLine("Higher level materials give more guild contribution.", 0.8, 0.8, 0.8)
	GameTooltip:Show()
end
