...
- Startup chat message moved into the register helper (printed only when AddonManager isn't loaded).
- Improved locale detection
- Added tooltips for the Donate Gold button and its checkbox.
